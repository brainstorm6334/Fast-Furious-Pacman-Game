...
class Board:
    ...
    def __init__(self):
        ...
        self.populateBoard()
        self.music = SoundFile(this, path + '/bgmusic' + str(level)+'.mp3')
        # self.music.amp(0.1)
...
class Player1(Creatures):
    ...
    def display(self):
        ...
        if self.r == xcoord1 and self.c == ycoord1:
...
class Player2(Creatures):
    ...
    def display(self):
        ...
        fill(0)
        stroke(0, 0, 0)
        if self.r == xcoord2 and self.c == ycoord2:
            rect(self.x, self.y, cellWidth, cellWidth)
...
class Game:
    ...
    def __init__(self):
        ...
        self.board = Board()
        self.music = SoundFile(this, path + '/menumusic.mp3')
        # self.music.amp(0.1)
        self.music.play()
        self.win = False
        self.loose = False
...
def draw():
    ...
    if game.state == 'menu':
        ...
        if 310 < mouseX < 950 and 560 < mouseY < 560 + 45:
            fill(230, 0, 38)
        else:
            fill(255)
